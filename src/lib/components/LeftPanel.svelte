...
<aside class="w-80 min-w-[320px] h-screen bg-cream text-walnut flex flex-col relative">
  ...
  <div class="p-8 pt-10 pb-0 z-30 relative bg-cream" style="view-transition-name: header-name">
  ...
  <div class="flex-1 flex flex-col p-8 pt-4 relative z-0 min-h-0">
    ...
    <nav class="flex-1 overflow-y-auto animate-slide-up min-h-0 scrollbar-hide pt-12 pb-[50%] -mx-8 mt-10" style="animation-delay: 0.4s" {@attach storeNav}>
